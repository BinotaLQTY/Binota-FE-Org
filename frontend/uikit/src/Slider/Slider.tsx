            ...
            <a.div
              className={css({
                ...
                _active: {
                  translate: "0 0px",
                  boxShadow: `
                    0 7px 4px rgba(138, 0, 196, 0.08),
                    0 3px 3px rgba(138, 0, 196, 0.13),
                    0 1px 1.5px rgba(138, 0, 196, 0.21)
                  `,
                },
              })}
              style={{
                ...
                background: disabled
                  ...
                  : moveSpring.handleColor,
                borderColor: `var(--borderColor${disabled ? "Disabled" : ""})`,
                transform: `
                  translateY(-50%)
                  translateY(${pressed ? "0px" : "0"})
                `,
              }}
            />
          </a.div>
...
function getGradientColors(gradientMode: GradientMode, totalColors: 3 | 5 = 5) {
  const colors =
    totalColors === 3 ? [gradient[0], gradient[2], gradient[4]] : gradient;
