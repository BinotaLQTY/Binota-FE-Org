...
export function Dropdown({
  ...
  const menuVisibility = useTransition(
    { groups: showMenu ? groups : null },
    {
          ...
          (buttonItem && (
            ...
            >
              {buttonItem.icon && buttonDisplay !== "label-only" && (
                <div style={{ marginLeft: -6 }}>{buttonItem.icon}</div>
              )}
              <div
                className={css({
                  display: "grid",
              ...
              <div>
                <IconChevronDown size={size === "small" ? 16 : 14} />
              </div>
            </div>
          ))}
      </button>
                          ...
                          item && (
                            <button
                              ...
                              onBlur={({ relatedTarget: focusTarget }) => {
                                // focus outside
                                if (
                                  !focusContainer.current?.contains(focusTarget)
                                ) {
