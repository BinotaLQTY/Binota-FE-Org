...
export type AllInterestRateBracketsQuery = { __typename?: 'Query', interestRateBrackets: Array<{ __typename?: 'InterestRateBracket', rate: string, totalDebt: string, sumDebtTimesRateD36: string, updatedAt: string, collateral: { __typename?: 'Collateral', collIndex: number } }> };
...
export type ActiveTrovesByBorrowerQueryVariables = Exact<{
  borrower: Scalars['Bytes']['input'];
}>;


export type ActiveTrovesByBorrowerQuery = { __typename?: 'Query', troves: Array<{ __typename?: 'Trove', id: string, borrower: string, debt: string, status: TroveStatus }> };

export type AllActiveTrovesQueryVariables = Exact<{
  skip: Scalars['Int']['input'];
  first: Scalars['Int']['input'];
}>;


export type AllActiveTrovesQuery = { __typename?: 'Query', troves: Array<{ __typename?: 'Trove', id: string, borrower: string, debt: string, status: TroveStatus }> };
...
export const ActiveTrovesByBorrowerDocument = new TypedDocumentString(`
  ...
  troves(
    ...
    `) as unknown as TypedDocumentString<ActiveTrovesByBorrowerQuery, ActiveTrovesByBorrowerQueryVariables>;
export const AllActiveTrovesDocument = new TypedDocumentString(`
  ...
  troves(
    ...
    `) as unknown as TypedDocumentString<AllActiveTrovesQuery, AllActiveTrovesQueryVariables>;