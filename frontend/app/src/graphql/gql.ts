...
const documents: Documents = {
    ...
    "\n  query ActiveTrovesByBorrower($borrower: Bytes!) {\n    troves(\n      where: { borrower: $borrower, status: active }\n      first: 1000\n      orderBy: debt\n      orderDirection: desc\n    ) {\n      id\n      borrower\n      debt\n      status\n    }\n  }\n": types.ActiveTrovesByBorrowerDocument,
    "\n  query AllActiveTroves($skip: Int!, $first: Int!) {\n    troves(\n      where: { status: active }\n      first: $first\n      skip: $skip\n      orderBy: debt\n      orderDirection: desc\n    ) {\n      id\n      borrower\n      debt\n      status\n    }\n  }\n": types.AllActiveTrovesDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query ActiveTrovesByBorrower($borrower: Bytes!) {\n    troves(\n      where: { borrower: $borrower, status: active }\n      first: 1000\n      orderBy: debt\n      orderDirection: desc\n    ) {\n      id\n      borrower\n      debt\n      status\n    }\n  }\n"): typeof import('./graphql').ActiveTrovesByBorrowerDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AllActiveTroves($skip: Int!, $first: Int!) {\n    troves(\n      where: { status: active }\n      first: $first\n      skip: $skip\n      orderBy: debt\n      orderDirection: desc\n    ) {\n      id\n      borrower\n      debt\n      status\n    }\n  }\n"): typeof import('./graphql').AllActiveTrovesDocument;
