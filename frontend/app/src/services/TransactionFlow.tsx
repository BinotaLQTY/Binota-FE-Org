...
import { claimAirdrop, type ClaimAirdropRequest } from "@/src/tx-flows/claimAirdrop";
...
export type FlowRequestMap = {
  ...
  "bridgeSend": BridgeSendRequest;
  "claimAirdrop": ClaimAirdropRequest;
...
const FlowIdSchema = v.union([
  ...
  v.literal("bridgeSend"),
  v.literal("claimAirdrop"),
