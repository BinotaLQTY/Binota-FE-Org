...
import { isAddress } from "@binota/uikit";
...
export const EnvSchema = v.pipe(
  v.object({
    ...
    BLOCKING_LIST: v.optional(v.union([vAddress(), v.null()]), null),
    ...
    KNOWN_DELEGATES_URL: v.optional(
    ...
    LIQUITY_GOVERNANCE_URL: v.optional(
      v.union([v.pipe(v.string(), v.url()), v.literal("")])
    ),
    SAFE_API_URL: v.optional(
      v.union([v.pipe(v.string(), v.url()), v.literal("")])
    ),
    ...
    // Airdrop contract addresses (optional - when not set, mock data is used)
    CONTRACT_NTA_REWARDS_CONTROLLER: v.optional(vAddress()),
    CONTRACT_NTA_MILESTONE_CONTROLLER: v.optional(vAddress()),
    CONTRACT_NTA_TOKEN: v.optional(vAddress()),
  ...
  v.transform((data) => {
    ...
    const defaultIcStrategiesForChain =
      DEFAULT_STRATEGIES.find(([chainId]) => chainId === env.CHAIN_ID)?.[1] ??
      null;
    ...
    for (const index of Array(10).keys()) {
      ...
      const icStrategiesKey =
        `${collEnvName}_IC_STRATEGIES` as keyof typeof env;
      const icStrategies =
        env[icStrategiesKey] === true
          ? true
      ...
      if (contractsCount !== contractsEnvNames.length) {
        throw new Error(
          `Incomplete contracts for collateral ${index} (${contractsCount}/${contractsEnvNames.length})`
        );
      }
...
const parsedEnv = v.safeParse(EnvSchema, {
  ...
  APP_VERSION_URL:
    process.env.NEXT_PUBLIC_APP_VERSION_URL ?? DEFAULT_VERSION_URL,
  ...
  CHAIN_CONTRACT_ENS_REGISTRY:
    process.env.NEXT_PUBLIC_CHAIN_CONTRACT_ENS_REGISTRY,
  CHAIN_CONTRACT_ENS_RESOLVER:
    process.env.NEXT_PUBLIC_CHAIN_CONTRACT_ENS_RESOLVER,
  ...
  CONTRACT_DEBT_IN_FRONT_HELPER:
    process.env.NEXT_PUBLIC_CONTRACT_DEBT_IN_FRONT_HELPER,
  ...
  COLL_0_CONTRACT_ACTIVE_POOL:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_ACTIVE_POOL,
  COLL_0_CONTRACT_BORROWER_OPERATIONS:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_BORROWER_OPERATIONS,
  COLL_0_CONTRACT_COLL_SURPLUS_POOL:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_COLL_SURPLUS_POOL,
  COLL_0_CONTRACT_COLL_TOKEN:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_COLL_TOKEN,
  COLL_0_CONTRACT_DEFAULT_POOL:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_DEFAULT_POOL,
  COLL_0_CONTRACT_LEVERAGE_ZAPPER:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_LEVERAGE_ZAPPER,
  COLL_0_CONTRACT_PRICE_FEED:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_PRICE_FEED,
  COLL_0_CONTRACT_SORTED_TROVES:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_SORTED_TROVES,
  COLL_0_CONTRACT_STABILITY_POOL:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_STABILITY_POOL,
  COLL_0_CONTRACT_TROVE_MANAGER:
    process.env.NEXT_PUBLIC_COLL_0_CONTRACT_TROVE_MANAGER,
  COLL_0_CONTRACT_TROVE_NFT: process.env.NEXT_PUBLIC_COLL_0_CONTRACT_TROVE_NFT,

  COLL_1_CONTRACT_ACTIVE_POOL:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_ACTIVE_POOL,
  COLL_1_CONTRACT_BORROWER_OPERATIONS:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_BORROWER_OPERATIONS,
  COLL_1_CONTRACT_COLL_SURPLUS_POOL:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_COLL_SURPLUS_POOL,
  COLL_1_CONTRACT_COLL_TOKEN:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_COLL_TOKEN,
  COLL_1_CONTRACT_DEFAULT_POOL:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_DEFAULT_POOL,
  COLL_1_CONTRACT_LEVERAGE_ZAPPER:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_LEVERAGE_ZAPPER,
  COLL_1_CONTRACT_PRICE_FEED:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_PRICE_FEED,
  COLL_1_CONTRACT_SORTED_TROVES:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_SORTED_TROVES,
  COLL_1_CONTRACT_STABILITY_POOL:
    process.env.NEXT_PUBLIC_COLL_1_CONTRACT_STABILITY_POOL,
  COLL_1_CONTRACT_TROVE_MANAGER:
  ...
  COLL_2_CONTRACT_ACTIVE_POOL:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_ACTIVE_POOL,
  COLL_2_CONTRACT_BORROWER_OPERATIONS:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_BORROWER_OPERATIONS,
  COLL_2_CONTRACT_COLL_SURPLUS_POOL:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_COLL_SURPLUS_POOL,
  COLL_2_CONTRACT_COLL_TOKEN:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_COLL_TOKEN,
  COLL_2_CONTRACT_DEFAULT_POOL:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_DEFAULT_POOL,
  COLL_2_CONTRACT_LEVERAGE_ZAPPER:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_LEVERAGE_ZAPPER,
  COLL_2_CONTRACT_PRICE_FEED:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_PRICE_FEED,
  COLL_2_CONTRACT_SORTED_TROVES:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_SORTED_TROVES,
  COLL_2_CONTRACT_STABILITY_POOL:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_STABILITY_POOL,
  COLL_2_CONTRACT_TROVE_MANAGER:
    process.env.NEXT_PUBLIC_COLL_2_CONTRACT_TROVE_MANAGER,
  COLL_2_CONTRACT_TROVE_NFT: process.env.NEXT_PUBLIC_COLL_2_CONTRACT_TROVE_NFT,

  COLL_3_CONTRACT_ACTIVE_POOL:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_ACTIVE_POOL,
  COLL_3_CONTRACT_BORROWER_OPERATIONS:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_BORROWER_OPERATIONS,
  COLL_3_CONTRACT_COLL_SURPLUS_POOL:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_COLL_SURPLUS_POOL,
  COLL_3_CONTRACT_COLL_TOKEN:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_COLL_TOKEN,
  COLL_3_CONTRACT_DEFAULT_POOL:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_DEFAULT_POOL,
  COLL_3_CONTRACT_LEVERAGE_ZAPPER:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_LEVERAGE_ZAPPER,
  COLL_3_CONTRACT_PRICE_FEED:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_PRICE_FEED,
  COLL_3_CONTRACT_SORTED_TROVES:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_SORTED_TROVES,
  COLL_3_CONTRACT_STABILITY_POOL:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_STABILITY_POOL,
  COLL_3_CONTRACT_TROVE_MANAGER:
    process.env.NEXT_PUBLIC_COLL_3_CONTRACT_TROVE_MANAGER,
...
export const VERCEL_ANALYTICS = parsedEnv.output.VERCEL_ANALYTICS;
