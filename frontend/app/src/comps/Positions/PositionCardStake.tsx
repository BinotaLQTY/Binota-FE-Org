...
import { HFlex, IconStake, TokenIcon } from "@binota/uikit";
      ...
      main={{
        value: (
          <HFlex gap={8} alignItems="center" justifyContent="flex-start">
            ...
            <TokenIcon size="medium" symbol="BINOTA" />
          </HFlex>
        ),
        label: (
          ...
          <CardRow
            start={
              ...
              >
                ...
                >
                  <Amount value={rewards} format="2diff" />
                  <TokenIcon size="mini" symbol="BINOTA" />
                </div>
              </div>
            }
          />
