...
export function NewPositionCard() {
  ...
  const spring = useSpring({
    ...
    to: {
      ...
      gridTemplateColumns: Array.from({ length: actionsEntries.length })
        .map((_, index) =>
          hovered === -1
              ...
              >
                <a.h1
                  ...
                  style={{
                    ...
                    transform: hprogress.to([0, 0.5, 1], [0, 1, 1]).to(
                      (p) => `
                    rotate(${(1 - p) * -90}deg)
                    translateY(${(1 - p) * 100}%)
                  `
                ...
                <a.p
                  ...
                  style={{
                    transform: hprogress.to([0, 0.9, 1], [0, 0, 1]).to(
                      (p) => `
                ...
                >
                  <ActionIcon
                    ...
                    state={
                      ANIMATE_ICONS && hovered === index ? "active" : "idle"
                    }
                  />
                </a.div>
              </section>
