import { HFlex, IconBorrow, StatusDot, TokenIcon } from "@binota/uikit";
...
export function PositionCardBorrow({
  ...
  "batchManager" | "borrowed" | "branchId" | "deposit" | "interestRate" | "isZombie" | "status" | "troveId"
> & { statusTag?: ReactNode }) {
          ...
          <CardRow
            start={
              ...
              >
                ...
                >
                  {status === "liquidated" ? "N/A" : fmtnum(interestRate, { preset: "pct2", suffix: "%" })}
                </div>
                {batchManager && (
                  <div
              ...
              >
                ...
                <StatusDot mode={riskLevelToStatusMode(redemptionRisk.data)} size={8} />
              </div>
            }
          />
        </CardRows>
