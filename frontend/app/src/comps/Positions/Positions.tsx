...
const actionCards = ["borrow", /* "multiply", */ "earn", "stake"] as const;
...
export function Positions({
  ...
  return (
    <PositionsGroup
      columns={
        breakpoint === "small" ? 1 : breakpoint === "medium" ? 2 : columns
      }
      mode={mode}
      positions={positions ?? []}
...
function PositionsGroup({
  ...
  const containerHeight =
    cardHeight * rows + (breakpoint === "small" ? 16 : 24) * (rows - 1);
