...
import { HFlex, IconStake, InfoTooltip, TokenIcon } from "@binota/uikit";
...
export function StakePositionSummary({
  ...
  const stakedShare =
    stakedLqty && totalStakedLqty && dn.gt(totalStakedLqty, 0)
      ? dn.div(stakedLqty, totalStakedLqty)
      : null;

  const appear = useAppear(
    !account.isConnected || loadingState === "success"
  );
                ...
                (style, show) =>
                  show && (
                    ...
                    >
                      ...
                      <TokenIcon symbol="BINOTA" size={32} />
                    </a.div>
                  )
              )}
              {prevStakePosition &&
