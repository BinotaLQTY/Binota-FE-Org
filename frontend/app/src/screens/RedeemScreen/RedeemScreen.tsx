      ...
      >
                ...
                >
                  <>
                    ...
                    <Amount
                      ...
                      suffix="%"
                      value={
                        redemptionRate.data ? dnum18(redemptionRate.data) : null
                      }
                      format="pct1z"
                    />
                  </>
                  <InfoTooltip
                    content={{
                      ...
                      body: (
                        <>
                          This is the maximum redemption fee you are willing to
                          pay. The redemption fee is a percentage of the
                          redeemed amount that is paid to the protocol. The
                          redemption fee must be higher than the current fee.
                        </>
                      ),
                      footerLink: {
        ...
        >
          ...
          <Button
            ...
            wide
            onClick={() => {
              if (amount.parsed && maxFee.parsed) {
                txFlow.start({
