...
//       icon={<IconEarn />}
//       columns={["Stability Pool", "Deposit", "Rewards"] as const}
//       placeholder="No active positions."
//       rows={
//         legacyPositions.isSuccess && spDeposits.length === 0
//           ? []
//           : [
...
//                         })}
//                       >
//                         <TokenIcon size="mini" symbol={branch.symbol} />
...
//                           successMessage:
//                             "The positions have been withdrawn successfully.",
...
//       icon={<IconBorrow />}
//       columns={["Collateral", "Deposit", "Borrowed", null] as const}
...
//                 })}
//               >
//                 <TokenIcon size="mini" symbol={trove.collToken.symbol} />
...
//                 })}
//               >
//                 <TokenAmount symbol={trove.collToken.symbol} value={coll} />
//               </div>
//             </td>
//             <td>
//               <div
...
//                 })}
//               >
//                 <TokenAmount symbol="LEGACY_BOLD" value={debt} />
//               </div>
//             </td>
//             <td>
//               <div
...
//                   <InfoTooltip
//                     level="warning"
//                     heading="Insufficient Legacy BOLD"
//                   >
//                     Your current Legacy BOLD balance (
//                     {fmtnum(boldBalance, { digits: 2 })} BOLD) is too low to
//                     close this loan. You need at least{" "}
//                     {fmtnum(debt, { digits: 2 })} BOLD to close this loan.
//                   </InfoTooltip>
//                 )}
//                 <Button
...
//   const legacyPositions = useLegacyPositions(account.address ?? null);
//   const stakeDeposit =
//     legacyPositions.data && dnum18(legacyPositions.data.stakeDeposit);
//   return (
//     <HomeTable
...
//       rows={
//         stakeDeposit && dn.eq(stakeDeposit, 0)
//           ? []
//           : [
//               <tr key="stake-deposit">
//                 <td>
//                   <TokenAmount symbol="BINOTA" value={stakeDeposit} />
//                 </td>
//                 <td>
//                   <div
//                     className={css({
...
//                             successLink: ["/legacy", "Go to legacy positions"],
//                             successMessage:
//                               "You have successfully unstaked your LQTY.",
...
//   const txFlow = useTransactionFlow();
//   const legacyPositions = useLegacyPositions(account.address ?? null);
//   const boldBalance = legacyPositions.data
//     ? dnum18(legacyPositions.data.boldBalance)
//     : null;
...
//     if (maxFee.isEmpty) {
//       maxFee.setValue(
//         fmtnum(dn.mul(dnum18(redemptionRate.data), 1.1), "pct2z")
//       );
//     }
...
//                     secondary={{
//                       start: `$${
//                         amount.parsed ? fmtnum(amount.parsed) : "0.00"
//                       }`,
//                       end: boldBalance && dn.gt(boldBalance, 0) && (
//                         <TextButton
...
//                             body: (
//                               <>
//                                 This is the maximum redemption fee you are
//                                 willing to pay. The redemption fee is a
//                                 percentage of the redeemed amount that is paid
//                                 to the protocol. The redemption fee must be
...
//                     })}
//                   >
//                     You will be charged a dynamic redemption fee (the more
//                     redemptions, the higher the fee).{" "}
//                     <Link
