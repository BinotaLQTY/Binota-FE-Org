...
export function PanelClosePosition({
  ...
  const collToReclaimUsd = collToReclaim && collPriceUsd.data && dn.mul(collToReclaim, collPriceUsd.data);
  ...
  return (
    <>
          ...
          <Field
            ...
            field={
              ...
              >
                ...
                >
                  <Amount value={amountToRepay} title={{ suffix: ` ${repayToken.name}` }} fallback="−" />
                </div>
                <Dropdown
                  buttonDisplay={() => ({
        ...
        <Field
          ...
          field={
            ...
            >
              ...
              >
                <Amount value={collToReclaim} title={{ suffix: ` ${collateral.name}` }} fallback="−" />
              </div>
              <div>
                <div
                  className={css({
      ...
      <FlowButton
        ...
        label={claimOnly ? content.closeLoan.buttonReclaimAndClose : content.closeLoan.buttonRepayAndClose}
        request={
          account.address && {
            flowId: "closeLoanPosition",
            backLink: [`/loan/close?id=${loan.branchId}:${loan.troveId}`, "Back to editing"],
