...
export const openLeveragePosition: FlowDeclaration<OpenLeveragePositionRequest> = {
  ...
  Summary({ request }) {
    return <LoanCard leverageMode={true} loadingState="success" loan={request.loan} onRetry={noop} txPreviewMode />;
  },
      ...
      <>
        <TransactionDetailsRow
          ...
          value={[
            ...
            collPrice.data && fmtnum(dn.mul(request.initialDeposit, collPrice.data), { preset: "2z", prefix: "$" }),
          ]}
        />
        <TransactionDetailsRow
          label="Debt"
        ...
        <TransactionDetailsRow
          ...
          value={[
            <div key="start" title={`${fmtnum(ETH_GAS_COMPENSATION, "full")} ETH`}>
