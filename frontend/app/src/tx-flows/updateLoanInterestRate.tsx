...
export const updateLoanInterestRate: FlowDeclaration<UpdateLoanInterestRateRequest> = {
  ...
  Details({ request }) {
    ...
    const yearlyBoldInterest = dn.mul(loan.borrowed, dn.add(loan.interestRate, delegate.data?.fee ?? 0));
        ...
        value={[
          ...
          <div key="end">
            {delegate.isLoading ? (
              ...
              <>
                <Amount value={loan.interestRate} format="pct2z" percentage />{" "}
                <Amount
                  percentage
                  format="pct2"
                  prefix="+ "
        ...
        {prevLoan.batchManager && (
          <TransactionDetailsRow
            ...
            value={[
              ...
              >
                <Amount value={prevLoan.interestRate} format="pct2z" percentage />{" "}
                <Amount
                  percentage
                  format="pct2"
                  prefix="+ "
    ...
    adjustInterestRate: {
      ...
      async commit(ctx) {
        ...
        return ctx.writeContract({
          ...
          args: [BigInt(loan.troveId), loan.interestRate[0], upperHint, lowerHint, maxUint256],
        });
      },
    ...
    setInterestBatchManager: {
      ...
      async commit(ctx) {
        ...
        return ctx.writeContract({
          ...
          args: [BigInt(loan.troveId), loan.batchManager, upperHint, lowerHint, maxUint256],
        });
      },
  ...
  async getSteps(ctx) {
    ...
    if (loan.batchManager) {
      return prevLoan.batchManager ? ["switchInterestBatchManager"] : ["setInterestBatchManager"];
    }
