  ...
  Summary({ request }) {
    ...
    const updatedEarnPosition = compound
      ? {
          ...
          deposit: dn.add(request.earnPosition.deposit, request.earnPosition.rewards.bold),
    ...
    const newPoolDeposit =
      compound && poolDeposit ? dn.add(poolDeposit, request.earnPosition.rewards.bold) : poolDeposit;
    ...
    return (
      <>
        <TransactionDetailsRow
          label={compound ? "Compound UNO rewards" : "Claim UNO rewards"}
          value={[
            <Amount key="start" value={rewardsBold} suffix=" UNO" />,
        ...
        <TransactionDetailsRow
          ...
          value={[
            <Amount key="start" value={rewardsColl} suffix={` ${collateral.name}`} />,
