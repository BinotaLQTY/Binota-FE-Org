...
import { shortenAddress, TokenIcon } from "@binota/uikit";
import { blo } from "blo";
import Image from "next/image";
import * as v from "valibot";
import { createRequestSchema, verifyTransaction } from "./shared";

const RequestSchema = createRequestSchema("claimCollateralSurplus", {
  borrower: vAddress(),
  collSurplus: vDnum(),
  branchId: vBranchId(),
});
...
export const claimCollateralSurplus: FlowDeclaration<ClaimCollateralSurplusRequest> =
  {
          ...
          >
            ...
            >
              ...
              >
                ...
                <TokenIcon size={32} symbol={collToken.symbol} />
              </div>
            </div>
          </div>
          <div
    ...
    Details({ request }) {
      ...
      return (
        <div className="p-4">
          <p>
            This will claim all available collateral surplus from your unclaimed
            liquidated positions for the {collateral?.name} collateral. The
            total amount will be sent to your wallet.
          </p>
        </div>
      );
    },
