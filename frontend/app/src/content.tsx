...
export default {
  ...
  closeLoan: {
    ...
    repayWithCollateralMessage: (collateralName: string) => (
      <>
        To close your position, part of your {collateralName} will be sold to
        pay back the debt. The rest will be returned to your wallet.
      </>
    ),
  ...
  home: {
    ...
    earnTable: {
      ...
      forksInfo: {
        text: (
          <>
            <abbr title="Stability Pool">SP</abbr> depositors earn additional
            rewards from forks.
          </>
        ),
        titleAttr:
          "Stability Pool depositors earn additional rewards from forks.",
        learnMore: {
          url: "https://docs.liquity.org/v2-documentation/friendly-fork-program",
          label: "Learn more",
          title: "Learn more about the Binota Friendly Fork Program",
        },
      },
    },
    yieldTable: {
    ...
    infoTooltips: {
      ...
      alsoClaimRewardsDeposit: [
        <>
          ...
          Otherwise rewards will be compounded into your deposit.
        </>,
      ],
...
function NoWrap({ children, gap = 8 }: { children: N; gap?: number }) {
  return (
    <span
      className={css({
        display: "inline-flex",
